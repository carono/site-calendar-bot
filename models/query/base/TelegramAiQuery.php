...
/**
 * This is the ActiveQuery class for \app\models\TelegramAi
 * @see \app\models\TelegramAi
 * @method \yii\db\BatchQueryResult|\app\models\TelegramAi[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\TelegramAi[] batch($batchSize = 100, $db = null)
 */
class TelegramAiQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
