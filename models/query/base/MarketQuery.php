...
/**
 * This is the ActiveQuery class for \app\models\Market
 * @see \app\models\Market
 * @method \yii\db\BatchQueryResult|\app\models\Market[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\Market[] batch($batchSize = 100, $db = null)
 */
