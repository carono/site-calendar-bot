...
/**
 * This is the ActiveQuery class for \app\models\UserWallet
 * @see \app\models\UserWallet
 * @method \yii\db\BatchQueryResult|\app\models\UserWallet[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\UserWallet[] batch($batchSize = 100, $db = null)
 */
