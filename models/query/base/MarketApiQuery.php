...
/**
 * This is the ActiveQuery class for \app\models\MarketApi
 * @see \app\models\MarketApi
 * @method \yii\db\BatchQueryResult|\app\models\MarketApi[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\MarketApi[] batch($batchSize = 100, $db = null)
 */
class MarketApiQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
	...
	{
		return $this->andWhere(['{{%market_api}}.[[deleted_at]]' => null]);
	}
