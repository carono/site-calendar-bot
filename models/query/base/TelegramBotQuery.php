...
/**
 * This is the ActiveQuery class for \app\models\TelegramBot
 * @see \app\models\TelegramBot
 * @method \yii\db\BatchQueryResult|\app\models\TelegramBot[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\TelegramBot[] batch($batchSize = 100, $db = null)
 */
class TelegramBotQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
