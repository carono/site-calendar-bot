...
/**
 * This is the ActiveQuery class for \app\models\TelegramLog
 * @see \app\models\TelegramLog
 * @method \yii\db\BatchQueryResult|\app\models\TelegramLog[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\TelegramLog[] batch($batchSize = 100, $db = null)
 */
class TelegramLogQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
