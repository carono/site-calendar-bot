...
/**
 * This is the ActiveQuery class for \app\models\SignalSource
 * @see \app\models\SignalSource
 * @method \yii\db\BatchQueryResult|\app\models\SignalSource[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\SignalSource[] batch($batchSize = 100, $db = null)
 */
class SignalSourceQuery extends ActiveQuery
{
	/**
	 * @return $this
	 */
	...
	/**
	 * @inheritdoc
	 * @return \app\models\SignalSource[]
	 */
