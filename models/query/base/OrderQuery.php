 ...
 * @method \yii\db\BatchQueryResult|\app\models\Order[] each($batchSize = 100, $db = null)
 * @method \yii\db\BatchQueryResult|\app\models\Order[] batch($batchSize = 100, $db = null)
 */
class OrderQuery extends ActiveQuery
{
	...
	{
		return $this->andWhere(['{{%order}}.[[deleted_at]]' => null]);
	}
